...
exports.createSauce = (req, res) => {
  ...
  const sauce = new Sauce(
    {...sauceObject, imageUrl: `${req.protocol}://${req.get('host')}/images/${req.file.filename}`, likes: 0, dislikes: 0, usersLiked: [],
    // usersDisliked: [],}); // faire une copie de l'objet sauce et rajouter éventuellement d'autres paramètres
    // name:
    // manufacturer: ,
    // description: ,
    // mainPepper: ,
