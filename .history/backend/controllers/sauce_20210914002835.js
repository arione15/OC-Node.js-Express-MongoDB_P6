...
exports.createSauce = (req, res) => {
  ...
  const sauce = new Sauce(
    {...sauceObject, imageUrl: `${req.protocol}://${req.get('host')}/images/${req.file.filename}`}); // faire une copie de l'objet sauce et rajouter éventuellement d'autres paramètres
