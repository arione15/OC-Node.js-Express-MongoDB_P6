...
password: {
    ...
    match: [/^(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9])(?=.*?[#?!@$%^&*-]).{8,}$/, 'Veuillez choisir un mot de passe valide ! (Huit caractères au moins, au moins une lettre majuscule, une lettre minuscule, un chiffre et un caractère spécial.)'] // 
