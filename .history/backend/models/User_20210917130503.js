...
password: {
    ...
    match: [/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}$/, 'Choisissez Please fill a valid email address'] // Huit caractères au moins, au moins une lettre majuscule, une lettre minuscule, un chiffre et un caractère spécial:
