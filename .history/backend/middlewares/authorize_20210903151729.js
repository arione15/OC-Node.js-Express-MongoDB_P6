...
module.exports = (req, res, next) => {
    try {
        ...
        if (req.body.userId && req.body.userId !== userId) { // vérifier s'il y a un userId dans le coprs de la requête et si oui, vérifier s'il correspond au userId encodé dans le token
