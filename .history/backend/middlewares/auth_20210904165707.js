...
module.exports = (req, res, next) => {
    try {
        ...
        const decodedToken = jwt.verify(token, APP_SECRET'RANDOM_TOKEN_SECRET'); // décoder le token à l'aide du code secret ==> le résultat du décodage est un objet js classique
