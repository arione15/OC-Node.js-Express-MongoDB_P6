...
module.exports = (req, res, next) => {
    try {
        ...
        const decodedToken = jwt.verify(token, process.env.APP_SECRETT); // décoder le token à l'aide du code secret ==> le résultat du décodage est un objet js classique
